...
const changeCurrentCard = function () {
    ...
    if (minCard) {
        ...
        minCard = {
            q: `Muito obrigado! 😊 Fico feliz em saber que você terminou a revisão. Se quiser revisar outros tópicos, estou aqui para ajudar. Boa sorte nos seus estudos! ${currentDeck} cards.`,
            a: `Desejo ótimos estudos para você!!!`,
        };
        if (get("deck-filter-input").value != "") {
